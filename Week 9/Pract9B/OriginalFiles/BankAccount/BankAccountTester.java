...
public class BankAccountTester
{
   ...
   {  
      ...
      BankAccount myAccount2 = new BankAccount(167);
	   ...
	   System.out.println("My account no " +myAccount.getAccNumber() );
		...
		System.out.println("My account no " +myAccount2.getAccNumber() );
		System.out.println("My account Initial Balance " +myAccount2.getBalance() );		
